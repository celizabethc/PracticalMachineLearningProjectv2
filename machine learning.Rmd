...
pred.rf <- predict(mod.rf, training.4, type = "class")

##Confusion Matrix
confusionMatrix(pred.rf, training.4$classe)
...
```
The confusion matrix reveals a very high accuracy for predicitions.
